            ...
            <div class="col-xl-12">
              <div class="row d-flex justify-content-between align-items-center">
                <div class="header-info-left">
                  <ul>
                    <li>Phone: +212 5 24242424</li>
                    <li>Email: pullman@contact.com</li>
                  </ul>
                </div>
  ...
  <main>
        ...
        <div class="row">
          <div class="col-xl-9 col-lg-9">
            <div class="hero__caption">
              <h1>Pullman <span>Logistic</span> Solutions!</h1>
            </div>
            <!--Hero form -->
    ...
    <!-- <div class="slider-area">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              ...
              <div class="carousel-caption d-none d-md-block">
                <h2 class="text-slide">First Slide</h2>
              </div>
            </div>
            <div class="carousel-item">
              <img class="d-block w-100" src="./assets/img/blog/single_blog_2.png" alt="Second slide">
              <div class="carousel-caption d-none d-md-block">
                <h2 class="text-slide">Second Slide</h2>
              </div>
            </div>
            <div class="carousel-item">
              <img class="d-block w-100" src="./assets/img/blog/single_blog_3.png" alt="Third slide">
              <div class="carousel-caption d-none d-md-block">
                <h2 class="text-slide">Third Slide</h2>
              </div>
            </div>
          </div> -->
      ...
      <!-- our info End -->
              ...
              <!-- Start Section Valeur -->

              
             <div class="team-area section-padding30">
              <h2 class="mr-3 container">Nos valeur :</h2>
                  <div class="container">
                    <div class="row justify-content-center">
                        <div class="card mr-3" style="width: 18rem;">
                           <img class="card-img-top" src="assets/img/section4/fiabilite.png" alt="Card image cap">
                              <div class="card-body">
                              <h2 class="card-text">Fiabilite</h2>
                                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                              </div>
                        </div>
                      <div class="card mr-3" style="width: 18rem;">
                        <img class="card-img-top" src="assets/img/section4/reactivite.png" alt="Card image cap">
                        <div class="card-body">
                        <h2 class="card-text">Reactivite</h2>
                          <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        </div>
                      </div>
                      <div class="card mr-3" style="width: 18rem;">
                        <img class="card-img-top" src="assets/img/section4/rapidite.png" alt="Card image cap">
                        <div class="card-body">

                          <h2 class="card-text">Rapidité</h2>
                          <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        </div>
                      </div>
                    </div>
